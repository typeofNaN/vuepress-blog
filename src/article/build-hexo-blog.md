...
![创建仓库](./build-hexo-blog/b2.jpg)

<!-- {% asset_img b3.jpg 为仓库取名 %} -->
![为仓库取名](./build-hexo-blog/b3.jpg)
...
![打开setting](./build-hexo-blog/b4.png)

将.ssh文件夹下的id_rsa.pub文件里一经复制好了的内容添加到ssh keys:

![创建key](./build-hexo-blog/b5.png)
