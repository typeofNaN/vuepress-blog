import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as d,c as r,a as c,d as e,f as s,b as l,e as n}from"./app-e8e12cd6.js";const p={},o=e("p",null,"通过pm2能守护node.js程序永远在线，在实际应用中是非常有必要的。另外，pm2配合keymetrics能实时监控node.js程序的运行，达到监控node.js程序的目的。",-1),m=n(`<h2 id="安装pm2" tabindex="-1"><a class="header-anchor" href="#安装pm2" aria-hidden="true">#</a> 安装pm2</h2><p>pm2可以使我们的node.js或io.js程序永远在线。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> pm2
...
pm2 updatePM2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用Keymetrics可以配合pm2来监控node.js程序（也支持io.js程序的监控）。</p><h2 id="安装keymetrics" tabindex="-1"><a class="header-anchor" href="#安装keymetrics" aria-hidden="true">#</a> 安装Keymetrics</h2>`,9),v={href:"https://app.keymetrics.io/#/register",target:"_blank",rel:"noopener noreferrer"},u=n(`<p>登录后，通过<code>new bucket</code>新建，然后进入控制面板，可以看到分配的<code>public key</code> 和<code>secret key</code>。然后，在安装有pm2的服务器端输入以下命令:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>pm2 interact your-secret-key your-public-key
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>此时，pm2会把收集到的统计信息实时地推送到Keymetrics，我们可以在Keymetrics的后台中实时地查看到node.js程序的运行信息，其中还有一些快捷操作，如重启node.js程序等。</p>`,5);function b(h,k){const a=t("ExternalLinkIcon");return d(),r("div",null,[o,c(" more "),m,e("p",null,[s("首先需要注册Keymetrics："),e("a",v,[s("Keymetrics"),l(a)])]),u])}const y=i(p,[["render",b],["__file","keymetrics.html.vue"]]);export{y as default};
